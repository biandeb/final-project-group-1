      ...
      <section id="home-desktop">
        ...
        <article className="container text-center section-categories">
          <div className="row">
            <div className="col-4">
              <div className="card">
                <img src={firstCateg} alt="Grilled marinated meat" className="card-img-top" />
                <div className="card-body">
                  <h5 className="card-title fw-bold title-cards">Grilled marinated meat</h5>
            ...
            <div className="col-4">
              <div className="card">
                <img src={secondCateg} className="card-img-top w-100" alt="Premium burguer"></img>
                <div className="card-body">
                  <h5 className="card-title fw-bold title-cards">Premium burguer</h5>
                  <p className="card-text text-cards">
            ...
            <div className="col-4">
              <div className="card">
                <img src={thirdCateg} className="card-img-top" alt="Grilled chicken"></img>
                <div className="card-body">
                  <h5 className="card-title fw-bold title-cards">Grilled chicken</h5>
                  <p className="card-text text-cards">
        ...
        <article className="bg-article p-3">
          ...
          <div className="row">
            <div className="col-6">
              <img src={cellphonePhoto} alt="cellphone with Grill and Thrills app" className="image-mobile" />
            </div>
            <div className="col-6">
              <img src={appStore} alt="download on app store" className="iphone-download" />
              <img src={googlePlay} alt="download on google play" className="google-download" />
            </div>
          </div>
          </div>
        </article>
