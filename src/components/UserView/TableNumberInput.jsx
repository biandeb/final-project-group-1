...
const TableNumberInput = (props) => {
    ...
    const handleSubmit = (data) =>{
        ...
        const newTableNumber = data;
        setTableNumber(newTableNumber);
    }

  return (
    <>
        <button type="button" className="btn table-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                <h1 className="modal-title fs-5" id="staticBackdropLabel">Enter your table number here</h1>
                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div className="modal-body">

{/* __________table number input_____________ */}
